...
export default function FloatingCTA() {
  ...
  return (
    ...
    >
      ...
      <div className="flex lg:hidden shadow-2xl">
        <a
          href={PHONE_URL}
      ...
      <div className="hidden lg:flex flex-col gap-3">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-3 px-5 py-3.5 bg-[#25D366] text-white rounded-2xl shadow-xl hover:bg-[#1da851] hover:shadow-2xl hover:-translate-y-0.5 transition-all duration-200 font-600"
          aria-label="Contact via WhatsApp"
        >
