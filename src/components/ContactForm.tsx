...
import { WHATSAPP_NUMBER, EMAIL_ADDRESS, EMAIL_URL } from "@/data/content";
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-3xl shadow-xl shadow-slate-100 p-8 sm:p-12">
          <div className="text-center mb-10">
            ...
            <p className="text-slate-500 text-lg mb-4">{subtitle}</p>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 border border-blue-100 text-slate-700 text-xs sm:text-sm font-500">
              <svg className="w-4 h-4 text-[#0A6EBD] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              <span>Email:</span>
              <a href={EMAIL_URL} className="text-[#0A6EBD] font-600 hover:underline">
                {EMAIL_ADDRESS}
              </a>
            </div>
          </div>
